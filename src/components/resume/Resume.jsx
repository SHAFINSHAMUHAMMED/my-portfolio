  ...
  return (
    <div id="resume" className=" container m-auto   mt-16">
      ...
      <div data-aos="fade-up" className="left flex-1 w-full">
        <p className=" text-gray-800 font-medium w-[100%]">
      ...
      <div className="card-wrapper w-[90%] sm:w-full mt-5 flex md:flex-col sm:gap-5 mx-auto ">
        <div className="left flex-1 flex items-center justify-center">
          ...
          >
            <legend className=" w-auto ml-[50%] bg-gray-100 translate-x-[-50%] border-2 border-gray-200 rounded-3xl py-1 px-8 font-semibold text-xl text-yellow-500">
              Experience
            </legend>
        ...
        <div className="right flex-1 flex items-center justify-center">
          <fieldset
            ...
            className=" w-[80%] p-5 py-12 sm:py-8 sm:w-full sm:p-2"
          >
            <legend className=" w-auto ml-[50%] translate-x-[-50%] border-2 bg-gray-100 border-gray-200 rounded-3xl py-1 px-8 font-semibold text-xl text-yellow-500">
              Education
            </legend>
            <div className=" relative">
              {/* design */}
              ...
              {/* design */}
              <div className=" flex flex-col gap-1 border-2 bg-white border-yellow-400 shadow-[0px_0px_16px_1px_rgba(0,0,0,0.1)] p-3 rounded-lg">
                <h1 className="text-[1.4rem] font-semibold sm:text-xl">
