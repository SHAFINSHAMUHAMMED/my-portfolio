...
export default function CTA() {
  ...
  return (
    <MotionContainer
      ...
      variants={containerVariants} // Add animation variants
    >
      <MotionStack spacing={{ base: '8', md: '10' }} variants={containerVariants}>
        <MotionStack
          spacing={{ base: '4', md: '5' }}
          align="center"
        ...
        >
          ...
          <Text color="gray.700" maxW="2xl" textAlign="center" fontSize="md">
            I have experience working on simple and complex projects. I’ve created apps, websites,
            scripts, and have deployed admin panels and databases/backends on the cloud. I enjoy
            taking on new challenges and working on experimental projects.
            <br />
